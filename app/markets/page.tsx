...
export default function Markets() {
  return (
    <div className="p-8 max-w-5xl mx-auto">
      {/* intro: art grid left, text right */}
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          <p className="text-2xl font-semibold">markets / vendor info</p>
      ...
      {/* workshops */}
      <div className="mt-12">
        <p className="text-2xl font-semibold">workshops</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-4">
          <div>
            ...
            <p className="font-semibold mt-3">cut + connected: accordion zine making</p>
          ...
          <div>
            ...
            <p className="font-semibold mt-3">build your own cyberdeck</p>
            <p className="text-base mt-1">
